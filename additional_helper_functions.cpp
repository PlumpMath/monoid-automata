...
//int stringToNumber(vector<char> str) {
//	int resultNumber = 0;
//	for (int i=0; i < str.size(); ++i) {
//		resultNumber += ( (int) (str[str.size() - 1 - i] - '0')) * pow(10, i);
//		str[i];
//	}
//	return resultNumber;
//}
...
//vector<char> reverceString(vector<char> str){
//	vector<char> res;
...
int stringToNumber(char str[], int str_size) {
	...
	//cout << "resultNumber = " << resultNumber << endl;
	return resultNumber;
}
